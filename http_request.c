...
/* TODO: Potentially replace this to pass a controller back */
/* Need to review rtd_cgi */
hw_route_entry *
get_route_callback(char* url)
{
...
void
hw_http_response_send(hw_http_response* response, void* user_data, http_response_complete_callback callback)
{
